...
def criar_items(tipo, faixa):

    if tipo=='ficha cassino':
        temp= ficha_cassino(800, 80, 80, faixa)
    elif tipo=='moeda':
        temp=moeda(400, 64, 64, faixa)
    elif tipo == 'fantasma':
        temp=fantasma(600, 56, 100, faixa)
    else:
        temp=interrogacao(500, 32, 100, faixa)
