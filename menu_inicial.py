...
class MenuInicial(GameState):
    ...
    def abrir_menu(self, carro_atual,continuar_musica):
        def tocar_musica():
            musica = pygame.mixer.music.load("assets/audios/musica_menu.mp3")
            pygame.mixer.music.play(-1)

        pygame.init()

        if not continuar_musica:
            tocar_musica()
        ...
        while self.run:
            ...
            self.escrever_texto_opcoes('Sair', fonte_menu, 305, 498, tela)
